...
#  :open_book: Enumerable <a name="about-project"></a>
...
```
git clone https://github.com/newhoteng/Enumerable.git
```

### Usage
To run the project, execute the following command:<br>
- Type `irb` inside the termimal to open Interactive Ruby
- Copy and paste expressions from `my_list.rb`, `my_enumerable.rb` into terminal and check their results (press enter after typing each one)
...
Feel free to check the [issues page](https://github.com/newhoteng/Enumerable/issues).
...
[License](https://github.com/newhoteng/Enumerable/blob/main/LICENSE)
